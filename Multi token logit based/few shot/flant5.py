...
def main():
    ...
    tracker = EmissionsTracker(
        project_name="flanT5-Logit-Calibrated",
        experiment_id="flant5_logit_eval",
    ...
    # -------- SECOND PASS --------
    for idx, (s_score, n_score, gold) in enumerate(zip(all_s_scores, all_n_scores, golds)):
