...
# ========================= CONFIG =========================
MODEL_NAME = "meta-llama/Llama-3.2-1B-Instruct"   # ✅ CHANGED
...
model = AutoModelForCausalLM.from_pretrained(
    ...
    device_map="auto",
    torch_dtype=torch.float16,   # ✅ REQUIRED FOR LLAMA
)
...
tracker = EmissionsTracker(
    project_name="LLaMA3.2-LoRA-Logit-Training",
...
print("\n✅ Logit-based LoRA training completed!")