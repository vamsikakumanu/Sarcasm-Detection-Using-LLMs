...
def main():
    parser = argparse.ArgumentParser(
        description="SmolLM-1.7B Zero-Shot Sarcasm Classification"
    )
    ...
    tracker = EmissionsTracker(
        project_name="SmolLM1.7B-ZeroShot-Sarcasm",
        experiment_id="smollm_zeroshot_eval",
    ...
    for start in tqdm(range(0, total, BATCH_SIZE), desc="Batches"):
        ...
        for i, seq in enumerate(outputs):
            ...
            pred = normalize_prediction(answer.lower())
