...
CSV_PATH = "E:\\preprocessed datasets\\IACV1.csv"
OUTPUT_DIR = r"F:\lora\adapters\olmo2_1B\IACV1"
...
tracker = EmissionsTracker(
    project_name="OLMo2-LoRA-Training",
...
print("✅ OLMo-2-1B LoRA adapter trained successfully")
